...
1. `tidy_gene_assignment()` takes the feature data and parses strings like `"NR_024005 // MGC13005 /// NR_024004 // MGC13005 /// AK093685 // MGC13005"` into a tidy data frame with two columns.
    ...
    When piped into `tidyr::unnest() %>% select(-gene_assignment)` this gives a nice tidy data frame.
